...
# Из модуля start_game_banner который расположен в graphic_arts,
...
def start_training(character):
    ...
    type_training = {'attack': character.attack,
                    'defence': character.defence,
                    'special': character.special}
    print('Потренируйся управлять своими навыками.')
    #print('f'{character.name}{type_training[character.__class__.__name__]}')
    ...
    while cmd != 'skip':
        ...
        if cmd in type_training:
            print(type_training[cmd])
...
if __name__ == '__main__':
    """Greeting and entering the name of the character."""
